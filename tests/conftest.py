...
@pytest.fixture
def valid_information(): # Для позитивного тестирования
...
@pytest.fixture
def information_without_executed(): # Для позитивного тестирования
...
@pytest.fixture
def information_without_canceled(): # Для позитивного тестирования
    return [{'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'},
            {'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572'},
...
@pytest.fixture
def information_with_same_dates(): # Для позитивного тестирования
    return [{'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'},
